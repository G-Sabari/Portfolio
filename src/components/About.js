...
export default function About(){
        const config = {
            subtitle:'Hi , My name is SABARI , Im a Front-end developer ! I built beautiful websites with React.js and Tailwindcss I have a solid foundation in frontend design, enhanced by my knowledge of tools like Figma, enabling me to translate concepts into pixel-perfect designs. I am always eager to collaborate in teams, exchange ideas, and contribute to innovative projects'
        }

    return <section className='flex bg-secondary px-5 py-5'id='about'>
        <div className='w-1/2'>
            <img src={Aboutimg}/>
        </div>
        <div className='w-1/2 flex justify-center'>
            <div className='flex flex-col justify-center'>
                ...
                <p className='text-white text-justify px-2 py-7'>Hi , My name is SABARI , Im a Front-end developer ! I built beautiful websites with React.js and Tailwindcss
